...
With no projects
If there are no projects shown, you can tap either the New Project button or the Plus icon to start a new project (see Creating a New Project).
 
With existing projects
Project list
If you have existing projects, this page displays a list of them. You can also tap anywhere on the project bar to invoke the chapter list (see Chapter list), or you can tap the Plus icon to start creating a new project (see Creating a New Project). 
...
•	Completion status
Information icon
Tap the Information icon (gray circle with a white ‘i’ inside) for a project and a popup window opens with further details about the project.
...
Tapping the Trashcan icon at the lower-left deletes your project. The other icons along the bottom right are for sharing your project (see Sharing Your Project).
